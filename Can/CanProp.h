...
#define CO_PROP_REL_CSG                 CN_PROPULSION*0x10+3

// Position "polaire" du robot :
// Longueur : 4
// B1-B0 : l, en mm
// B3-B2 : alpha, en degré/10
#define CO_PROP_REL_ODO                 CN_PROPULSION*0x10+4
...
//              PROP_IS_UNMOVABLE_OBSTACLE si le point défini dans l'ordre se trouve dans un obstacle fixe (obstacle de la carte initiale)
//              PROP_IS_MOVABLE_OBSTACLE si le point défini dans l'ordre se trouve dans un obstacle amovible (ajouté par l'ordre PROP_ADD_OBSTACLE)
#define CO_PROP_IS_OBSTACLE             CN_PROPULSION*0x10+5
