...
#define SEUIL_COLLISION_AVANT       350//279     //<! Seuil de détection (sur la valeur numérique fournie par l'ADC).
#define HYSTERESE_AVANT             60      //<! Hystérèse pour le sharp avant
#define DISTANCE_DETECTION          200     //<! Distance à laquelle on détecte un obstacle [mm]
#define CENTER_TO_SHARPS_AVANT      100     //<! Distance entre le centre odométrique du robot et l'axe du sharp [mm]
