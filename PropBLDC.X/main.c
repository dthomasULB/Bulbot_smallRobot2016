...
int main(void) {
    ...
    propIsObstacleType obstacle;             // on définit une variable obstacle permettant l'interrogation de la logique
    // DENIS 02/03/2016
    int patinageEnable = 0;
    int backward = 0;                       // Variable permettant de faire des trajet en arrière
    int curSeg, nbSeg;
    enum {
        XY,
        XYALPHA
