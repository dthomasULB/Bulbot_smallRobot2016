...
# 1 "../libdspic/pwm.h" 1
# 10 "../libdspic/pwm.h"
# 1 "../libdspic/../libdspic/timers.h" 1
# 31 "../libdspic/../libdspic/timers.h"
typedef enum {
    TIMER_SUCCESS = 0,
    TIMER_ID_ERROR = 1,
    TIMER_PERIOD_ERROR = 2,
}timerStatus;
# 44 "../libdspic/../libdspic/timers.h"
...
void __attribute__((interrupt, no_auto_psv)) _CNInterrupt(void) {
 ...
 hallValueR = PORTCbits.RC9*4 + PORTCbits.RC8*2 + PORTCbits.RC7*1;
 hallValueL = PORTCbits.RC6*4 + PORTBbits.RB9*2 + PORTBbits.RB8*1;
...
void motorsInit(void) {
 ...
 oldHallValueR = PORTCbits.RC9*4 + PORTCbits.RC8*2 + PORTCbits.RC7*1;

 oldHallValueL = PORTCbits.RC6*4 + PORTBbits.RB9*2 + PORTBbits.RB8*1;
...
void motorsEnable(void) {
    P1DC1 = 0; P1DC2 = 0; OC2RS = 0;
    OC3RS = 0; OC4RS = 0; OC1RS = 0;
 LATBbits.LATB15 = 1; LATAbits.LATA7 = 1; LATAbits.LATA10 = 1;
 LATAbits.LATA8 = 1; LATCbits.LATC1 = 1; LATBbits.LATB3 = 1;
}

void motorsDisable(void) {
    P1DC1 = 0; P1DC2 = 0; OC2RS = 0;
    OC3RS = 0; OC4RS = 0; OC1RS = 0;
 LATBbits.LATB15 = 0; LATAbits.LATA7 = 0; LATAbits.LATA10 = 0;
 LATAbits.LATA8 = 0; LATCbits.LATC1 = 0; LATBbits.LATB3 = 0;
}
...
void motorsSetSpeed(float dutyCycleRight, float dutyCycleLeft) {
 ...
 if (dutyCycleRight >= 0) {
  privateBldcPwm.rightPwm = (int)(dutyCycleRight*400);
  privateBldcPwm.rightCw = 0;
 } else {
  privateBldcPwm.rightPwm = -(int)(dutyCycleRight*400);
 ...
 if (dutyCycleLeft >= 0) {
  privateBldcPwm.leftPwm = (int)(dutyCycleLeft*400);
  privateBldcPwm.leftCw = 1;
 } else {
  privateBldcPwm.leftPwm = -(int)(dutyCycleLeft*400);
  privateBldcPwm.leftCw = 0;
 }
 if (privateBldcPwm.rightPwm > 399) {
  privateBldcPwm.rightPwm = 399;
 }
 if (privateBldcPwm.leftPwm > 399) {
  privateBldcPwm.leftPwm = 399;
 }
 BldcUpdateSpeed();
}
...
inline void BldcUpdateSpeed(void) {
 if (privateBldcPwm.rightCw == 1) {
  switch (hallValueR) {
   case 1:
    P1DC1 = 2*privateBldcPwm.rightPwm; P1DC2 = 0; OC2RS = 1;
    LATBbits.LATB15 = 1; LATAbits.LATA7 = 0; LATAbits.LATA10 = 1;
    break;
   case 2:
    P1DC1 = 1; P1DC2 = 2*privateBldcPwm.rightPwm; OC2RS = 0;
    LATBbits.LATB15 = 1; LATAbits.LATA7 = 1; LATAbits.LATA10 = 0;
    break;
   case 3:
    P1DC1 = 0; P1DC2 = 2*privateBldcPwm.rightPwm; OC2RS = 1;
    LATBbits.LATB15 = 0; LATAbits.LATA7 = 1; LATAbits.LATA10 = 1;
    break;
   case 4:
    P1DC1 = 0; P1DC2 = 1; OC2RS = privateBldcPwm.rightPwm;
    LATBbits.LATB15 = 0; LATAbits.LATA7 = 1; LATAbits.LATA10 = 1;
    break;
   case 5:
    P1DC1 = 2*privateBldcPwm.rightPwm; P1DC2 = 1; OC2RS = 0;
    LATBbits.LATB15 = 1; LATAbits.LATA7 = 1; LATAbits.LATA10 = 0;
    break;
   case 6:
    P1DC1 = 1; P1DC2 = 0; OC2RS = privateBldcPwm.rightPwm;
    LATBbits.LATB15 = 1; LATAbits.LATA7 = 0; LATAbits.LATA10 = 1;
    break;
   default:
    P1DC1 = 0; P1DC2 = 0; OC2RS = 0;
 ...
 if (privateBldcPwm.leftCw == 1) {
  switch (hallValueL) {
   case 1:
    OC3RS = privateBldcPwm.leftPwm; OC4RS = 0; OC1RS = 1;
    LATAbits.LATA8 = 1; LATCbits.LATC1 = 0; LATBbits.LATB3 = 1;
    break;
   case 2:
    OC3RS = 1; OC4RS = privateBldcPwm.leftPwm; OC1RS = 0;
    LATAbits.LATA8 = 1; LATCbits.LATC1 = 1; LATBbits.LATB3 = 0;
    break;
   case 3:
    OC3RS = 0; OC4RS = privateBldcPwm.leftPwm; OC1RS = 1;
    LATAbits.LATA8 = 0; LATCbits.LATC1 = 1; LATBbits.LATB3 = 1;
    break;
   case 4:
    OC3RS = 0; OC4RS = 1; OC1RS = privateBldcPwm.leftPwm;
    LATAbits.LATA8 = 0; LATCbits.LATC1 = 1; LATBbits.LATB3 = 1;
    break;
   case 5:
    OC3RS = privateBldcPwm.leftPwm; OC4RS = 1; OC1RS = 0;
    LATAbits.LATA8 = 1; LATCbits.LATC1 = 1; LATBbits.LATB3 = 0;
    break;
   case 6:
    OC3RS = 1; OC4RS = 0; OC1RS = privateBldcPwm.leftPwm;
    LATAbits.LATA8 = 1; LATCbits.LATC1 = 0; LATBbits.LATB3 = 1;
    break;
   default:
    OC3RS = 0; OC4RS = 0; OC1RS = 0;
