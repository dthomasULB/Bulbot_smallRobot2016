...
# 10 "odoLibre.c" 2
# 20 "odoLibre.c"
volatile absolutePosType prOdoAbsPos;
volatile relativePosType prOdoRelVel, prOdoRelPos;

void odoInit(void) {

    ppsInConfig(PPS_QEA1, 6);
    ppsInConfig(PPS_QEB1, 7);

    ppsInConfig(PPS_QEA2, 19);
    ppsInConfig(PPS_QEB2, 20);
    prOdoRelVel.l = 0;
    prOdoRelVel.r = 0;
    prOdoRelPos.l = 0;
    prOdoRelPos.r = 0;
...
void calculeOdometrie(void) {
    ...
    dT = (1.0001 * rightVel + 0.9999 * leftVel) * ((3.14159)*48.9E-3/4096/2);
    dR = (1.0001 * rightVel - 0.9999 * leftVel) * ((3.14159)*48.9E-3/4096/86.72865E-3);
# 85 "odoLibre.c"
    ...
    prOdoRelPos.l += dT;
    prOdoRelPos.r += dR;
    prOdoRelVel.l = dT * 100.0;
    prOdoRelVel.r = dR * 100.0;
}
