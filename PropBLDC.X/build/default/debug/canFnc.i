...
# 31 "../libdspic/timers.h"
typedef enum {
    TIMER_SUCCESS = 0,
    TIMER_ID_ERROR = 1,
    TIMER_PERIOD_ERROR = 2,
}timerStatus;
# 44 "../libdspic/timers.h"
...
positionInteger canAbsPos;
propStateType canState;
propIsObstacleType canObsType;
relativeCoordInteger canOdoRelPos, canCsgRelPos;
char canPatinage = 1;
...
void canPropInit(void) {
 ...
 CanDeclarationProduction(0x02*0x10+0, &canState, sizeof(canState));
 CanDeclarationProduction(0x02*0x10+2, &canAbsPos, sizeof(canAbsPos));
 CanDeclarationProduction(0x02*0x10+3, &canCsgRelPos, sizeof(canCsgRelPos));
 CanDeclarationProduction(0x02*0x10+4, &canOdoRelPos, sizeof(canOdoRelPos));
 CanDeclarationProduction(0x02*0x10+1, &canPatinage, sizeof(canPatinage));
    CanDeclarationProduction(0x02*0x10+5, &canObsType, sizeof(canObsType));
...
absolutePosType canOrderGetPos(void) {
 ...
 newPos.alpha = ((3.14159)/1800.0)*tempINTEG.i;
...
rotationParamType canGetRotation(void) {
 ...
 tempINTEG.ub[0] = canReceivedData[0]; tempINTEG.ub[1] = canReceivedData[1];
 param.acc = ((3.14159)/1800.0)*tempINTEG.i;
 tempINTEG.ub[0] = canReceivedData[2]; tempINTEG.ub[1] = canReceivedData[3];
 param.vel = ((3.14159)/1800.0)*tempINTEG.i;
 tempINTEG.ub[0] = canReceivedData[4]; tempINTEG.ub[1] = canReceivedData[5];
 param.angle = ((3.14159)/1800.0)*tempINTEG.i;
