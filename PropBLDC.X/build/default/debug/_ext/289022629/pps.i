...
ppsStatus ppsInConfig(ppsInput periphInput, int rpPin) {
 ...
 switch (periphInput) {
  case PPS_U1RX : RPINR18bits.U1RXR = rpPin; break;
  case PPS_U1CTS : RPINR18bits.U1CTSR = rpPin; break;
  case PPS_U2RX : RPINR19bits.U2RXR = rpPin; break;
  case PPS_U2CTS : RPINR19bits.U2CTSR = rpPin; break;
  case PPS_SDI1 : RPINR20bits.SDI1R = rpPin; break;
  case PPS_IN_SCK1 : RPINR20bits.SCK1R = rpPin; break;
  case PPS_IN_SS1 : RPINR21bits.SS1R = rpPin; break;
  case PPS_SDI2 : RPINR22bits.SDI2R = rpPin; break;
  case PPS_IN_SCK2 : RPINR22bits.SCK2R = rpPin; break;
  case PPS_IN_SS2 : RPINR23bits.SS2R = rpPin; break;
  case PPS_IN_C1RX : RPINR26bits.C1RXR = rpPin; break;

  case PPS_QEA1 : RPINR14bits.QEA1R = rpPin; break;
  case PPS_QEB1 : RPINR14bits.QEB1R = rpPin; break;
  case PPS_QEA2 : RPINR16bits.QEA2R = rpPin; break;
  case PPS_QEB2 : RPINR16bits.QEB2R = rpPin; break;
