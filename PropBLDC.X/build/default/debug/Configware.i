...
__attribute__((section("__FICD.sec"),space(prog))) unsigned int _FICD = (0xFFDF);;

__attribute__((section("__FWDT.sec"),space(prog))) unsigned int _FWDT = (0xFF7F);;

__attribute__((section("__FGS.sec"),space(prog))) unsigned int _FGS = (0xFFFF & 0xFFFF & 0xFFFF);;
# 24 "Configware.c"
__attribute__((section("__FOSCSEL.sec"),space(prog))) unsigned int _FOSCSEL = (0xFFF8);;

__attribute__((section("__FOSC.sec"),space(prog))) unsigned int _FOSC = (0xFF7F & 0xFFFF & 0xFFFD);;
