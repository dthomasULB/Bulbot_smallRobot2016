...
# 1 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\generic\\h/xc.h" 1 3 4
# 1478 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\generic\\h/xc.h" 3 4
# 1 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 1 3 4
# 16 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
...
# 2098 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
...
# 23115 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern void *_DMA_BASE __attribute__((far));
# 23124 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FBS;
# 23197 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FSS;
# 23270 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FGS;
# 23306 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FOSCSEL;
# 23348 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FOSC;
# 23398 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FWDT;
# 23470 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FPOR;
# 23533 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FICD;
# 23565 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FUID0;
# 23584 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FUID1;
# 23603 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FUID2;
# 23622 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\dsPIC33F\\h/p33FJ128MC804.h" 3 4
extern __attribute__((space(prog))) unsigned int _FUID3;
# 1479 "c:\\program files (x86)\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\support\\generic\\h/xc.h" 2 3 4
# 8 "../libdspic/CanDspic.h" 2
# 36 "../libdspic/CanDspic.h"
typedef struct
{
 unsigned char id;
 void *ptrData;
...
extern CAN_MSG production[8];


extern CAN_MSG consommation[15];

extern BUFFER_CAN transmitBuffers[8] __attribute__((space(dma),address(0x4000 +0x0000)));
extern BUFFER_CAN receiveBufferOrders __attribute__((space(dma),address(0x4000 +0x0090)));
extern BUFFER_CAN receiveBufferObjects __attribute__((space(dma),address(0x4000 +0x0080)));

extern unsigned char canReceivedCommand;
extern unsigned char canReceivedData[7];
...
# 2 "../libdspic/CanDspic.c" 2
# 25 "../libdspic/CanDspic.c"
CAN_MSG production[8];


CAN_MSG consommation[15];

BUFFER_CAN transmitBuffers[8] __attribute__((space(dma),address(0x4000 +0x0000)));
BUFFER_CAN receiveBufferOrders __attribute__((space(dma),address(0x4000 +0x0090)));
BUFFER_CAN receiveBufferObjects __attribute__((space(dma),address(0x4000 +0x0080)));
...
typedef enum _CAN_OP_MODE
{
    ...
    CAN_OP_MODE_DISABLE = 0x01,
    CAN_OP_MODE_LOOP = 0x02,
    CAN_OP_MODE_LISTEN_ONLY = 0x03,
    CAN_OP_MODE_CONFIG = 0x04,
    CAN_OP_MODE_LISTEN_ALL = 0x07
} CAN_OP_MODE;
...
unsigned char canReceivedCommand;
unsigned char canReceivedData[7];
unsigned char canReceivedOrderFlag;
...
void CanSetBaudRate(CAN_BAUDRATE baudrate)
{
 ...
 CAN_OP_MODE currentMode = C1CTRL1bits.OPMODE;
...
# 295 "../libdspic/CanDspic.c"
 C1CFG1bits.SJW = 0x3;


 C1CFG1bits.BRP = ((40000000/(2*20*baudrate))-1);
...
void ChargerFiltre(unsigned char numero, unsigned char id)
{
 ...
 switch (numero)
 {
  case 0 : C1RXF0SID = id << 5L; C1FEN1bits.FLTEN0 = 1; break;
  case 1 : C1RXF1SID = id << 5L; C1FEN1bits.FLTEN1 = 1; break;
  case 2 : C1RXF2SID = id << 5L; C1FEN1bits.FLTEN2 = 1; break;
  case 3 : C1RXF3SID = id << 5L; C1FEN1bits.FLTEN3 = 1; break;
  case 4 : C1RXF4SID = id << 5L; C1FEN1bits.FLTEN4 = 1; break;
  case 5 : C1RXF5SID = id << 5L; C1FEN1bits.FLTEN5 = 1; break;
  case 6 : C1RXF6SID = id << 5L; C1FEN1bits.FLTEN6 = 1; break;
  case 7 : C1RXF7SID = id << 5L; C1FEN1bits.FLTEN7 = 1; break;
  case 8 : C1RXF8SID = id << 5L; C1FEN1bits.FLTEN8 = 1; break;
  case 9 : C1RXF9SID = id << 5L; C1FEN1bits.FLTEN9 = 1; break;
  case 10 : C1RXF10SID = id << 5L; C1FEN1bits.FLTEN10 = 1; break;
  case 11 : C1RXF11SID = id << 5L; C1FEN1bits.FLTEN11 = 1; break;
  case 12 : C1RXF12SID = id << 5L; C1FEN1bits.FLTEN12 = 1; break;
  case 13 : C1RXF13SID = id << 5L; C1FEN1bits.FLTEN13 = 1; break;
  case 14 : C1RXF14SID = id << 5L; C1FEN1bits.FLTEN14 = 1; break;
  case 15 : C1RXF15SID = id << 5L; C1FEN1bits.FLTEN15 = 1; break;
  default : break;
 }
